...
public class Main extends JFrame implements MouseListener
{
	...
	private static Rook wr01,wr02,wr03,wr04,wr05,wr06,wr07,wr08,br01,br02,br03,br04,br05,br06,br07,br08;
	...
	private JPanel board=new JPanel(new GridLayout(12,12));
	...
	wr03=new Rook("WR03","White_Rook.png",0);
	wr04=new Rook("WR04","White_Rook.png",0);
	wr05=new Rook("WR05","White_Rook.png",0);
	wr06=new Rook("WR06","White_Rook.png",0);
	wr07=new Rook("WR07","White_Rook.png",0);
	wr08=new Rook("WR08","White_Rook.png",0);
	br01=new Rook("BR01","Black_Rook.png",1);
	br02=new Rook("BR02","Black_Rook.png",1);
	br03=new Rook("BR03","Black_Rook.png",1);
	br04=new Rook("BR04","Black_Rook.png",1);
	br05=new Rook("BR05","Black_Rook.png",1);
	br06=new Rook("BR06","Black_Rook.png",1);
	br07=new Rook("BR07","Black_Rook.png",1);
  ...
  //Function to check if the king will be in danger if the given move is made
    ...
    {
    	Cell newboardstate[][] = new Cell[12][12];
    	for(int i=0;i<12;i++)
    		for(int j=0;j<12;j++)
